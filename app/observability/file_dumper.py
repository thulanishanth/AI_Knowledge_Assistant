...
def _initialize_dump_files() -> None:
    for dump_file in (
        USER_FILE,
        AI_FILE,
        TIME_FILE,
...
def sync_dump_to_txt(user_query: str, ai_response: str, full_prompt: str, rag_context: str, generated_sql: str, execution_status: str,
    ...
    try:
        ...
        prompt_block = f"--- PROMPT DUMP: {now_str} ---\n{human_readable_prompt or 'None'}\n----------------------------------------\n\n"
        ...
        log_entry = {
            "timestamp": now_iso, "local_time": now_str, "llm_model": llm_model_name,
            "max_context_window": max_context_window, "estimated_tokens": estimated_tokens,
            "user_query": user_query or "", "generated_sql": generated_sql or "",
            "execution_status": execution_status or "", "ai_response": ai_response or "",
            "rag_context": rag_context or "", "full_prompt": full_prompt or ""
        }
